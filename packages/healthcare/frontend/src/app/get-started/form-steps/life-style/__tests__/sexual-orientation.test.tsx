...
import { SexualOrientationStep } from '../sexual-orientation'
...
describe('Birth sex tests', () => {
  ...
  it('should display the next button when a value is selected', async () => {
    await act(async () => {
      fireEvent.click(Component.getByLabelText('Straight'))
    })
    ...
    expect(navigateToStepMockFn).toHaveBeenCalledWith('CurrentRelationship')
  })
})
